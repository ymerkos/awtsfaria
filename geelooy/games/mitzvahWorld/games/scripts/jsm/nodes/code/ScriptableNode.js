...
class ScriptableNode extends Node {
	...
	getObject() {
		...
		const THREE = global.get( '/games/scripts/build/three.module.js' );
	...
	getMethod() {
		...
		const parametersProps = [ 'parameters', 'local', 'global', 'refresh', 'setOutput', '/games/scripts/build/three.module.js', 'TSL' ];
